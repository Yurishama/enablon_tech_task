...
(function () {
    ...
    ***************************************************************************** */
    ...
    var REQUIRED_ATTR_NAME = 'required';
    var FORM_SUBMIT_EVENT_NAME = 'submit';
    var UploadAutomation = /** @class */ (function () {
        function UploadAutomation(element, paths, createError, isNativeAutomation) {
            this.element = element;
            this.paths = paths;
        ...
        UploadAutomation.prototype._handleRequiredInput = function () {
            var _this = this;
            var isRequired = hammerhead.nativeMethods.hasAttribute.call(this.element, REQUIRED_ATTR_NAME);
            if (isRequired)
                hammerhead.nativeMethods.removeAttribute.call(this.element, REQUIRED_ATTR_NAME);
            var ensureUploadInputHasRequiredAttribute = function () {
                if (isRequired)
                    hammerhead.nativeMethods.setAttribute.call(_this.element, REQUIRED_ATTR_NAME, 'true');
            };
            hammerhead.eventSandbox.listeners.initElementListening(this.element.form, [FORM_SUBMIT_EVENT_NAME]);
            hammerhead.eventSandbox.listeners.addInternalEventAfterListener(this.element.form, [FORM_SUBMIT_EVENT_NAME], ensureUploadInputHasRequiredAttribute);
        };

...
(function () {
    ...
    ***************************************************************************** */
    ...
    function generateId () {
        return "".concat(hammerhead.nativeMethods.performanceNow(), ".").concat(Math.floor(Math.random() * 100000));
    }
    ...
    ActionExecutor.ACTIONS_HANDLERS[COMMAND_TYPE.setFilesToUpload] = {
        create: function (command, elements, dispatchNativeAutomationEventFn) {
            return new testcafeAutomation.Upload(elements[0], command.filePath, function (filePaths, scannedFilePaths) { return new ActionCannotFindFileToUploadError(filePaths, scannedFilePaths); }, dispatchNativeAutomationEventFn);
        },
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._addChildWindowDriverLink = function (wnd, windowId) {
            var childWindowDriverLink = new ChildWindowDriverLink(wnd, windowId);
        ...
        Driver.prototype._ensureNewWindowOpenedInNativeAutomation = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, testcafeCore.browser.ensureWindowInNativeAutomation(this.communicationUrls.ensureWindowInNativeAutomationUrl, hammerhead__default.createNativeXHR)];
                        case 1:
                            result = _a.sent();
                            if (!result.windowId)
                                return [2 /*return*/, null];
                            if (e.form)
                                nativeMethods$6.formSubmit.apply(e.form);
                            else
                                nativeMethods$6.windowOpen.call(window, e.pageUrl, e.windowName);
                            return [2 /*return*/, result.windowId];
                    }
                });
            });
        };
        Driver.prototype._onChildWindowOpened = function (e, isOpeningInIframe) {
            return __awaiter(this, void 0, void 0, function () {
                var windowId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            windowId = e.windowId;
                            if (!(this.options.nativeAutomation && !isOpeningInIframe)) return [3 /*break*/, 2];
                            this._waitChildWindowOpenedInNativeAutomation = this._ensureNewWindowOpenedInNativeAutomation(e);
                            return [4 /*yield*/, this._waitChildWindowOpenedInNativeAutomation];
                        case 1:
                            windowId = _a.sent();
                            if (!windowId)
                                return [2 /*return*/];
        ...
        Driver.prototype._getWindowInfo = function () {
            ...
            if (!this.options.nativeAutomation) {
                var destUrl = hammerhead__default.utils.url.parseProxyUrl(url).destUrl;
                url = destUrl;
            }
            return {
                id: this.windowId,
        ...
        Driver.prototype._onActionCommand = function (command) {
            ...
            executor.execute(barriers)
                ...
                if (_this._waitChildWindowOpenedInNativeAutomation)
                    return _this._waitChildWindowOpenedInNativeAutomation.then(function () { return driverStatus; });
                return driverStatus;
            })
                .then(function (driverStatus) {
        ...
        Driver.prototype._restoreChildWindowLinks = function () {
            return __awaiter(this, void 0, void 0, function () {
                var pendingChildWindowCount, restoreChildWindowsPromise, err_2;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            pendingChildWindowCount = this.contextStorage.getItem(PENDING_CHILD_WINDOW_COUNT);
        ...
        Driver.prototype._onSetBreakpointCommand = function (_a) {
            var _this = this;
            var isTestError = _a.isTestError, selector = _a.selector;
    ...
    var IframeDriver = /** @class */ (function (_super) {
        ...
        function IframeDriver(testRunId, communicationsUrls, options) {
            var _this = _super.call(this, testRunId, communicationsUrls, {}, options) || this;
        ...
        IframeDriver.prototype._onChildWindowOpened = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var windowId;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.options.nativeAutomation) return [3 /*break*/, 2];
                            return [4 /*yield*/, this._ensureNewWindowOpenedInNativeAutomation(e)];
                        case 1:
                            windowId = _a.sent();
                            if (!windowId)
                                return [2 /*return*/];

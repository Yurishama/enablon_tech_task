...
(function () {
    ...
    ***************************************************************************** */
    ...
    function castArray(elements) {
        return nativeMethods$a.isArray(elements) ? elements : [elements];
    }
    ...
    var SelectorInputContainer = /** @class */ (function () {
        ...
        Object.defineProperty(SelectorInputContainer.prototype, "value", {
            get: function () {
                return nativeMethods$b.inputValueGetter.call(this.input);
            },
            set: function (value) {
                nativeMethods$b.inputValueSetter.call(this.input, value);
            },
            enumerable: false,
            configurable: true
        });
        ...
        SelectorInputContainer.prototype._setMatchIndicatorText = function (text) {
            nativeMethods$b.nodeTextContentSetter.call(this.indicator, text);
        };
        ...
        SelectorInputContainer.prototype.debugSelector = function (selector) {
            return __awaiter(this, void 0, void 0, function () {
                var elements, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = castArray;
                            return [4 /*yield*/, executeSelector(selector)];
                        case 1:
                            elements = _a.apply(void 0, [_b.sent()]);
                            this._indicateMatches(elements);
                            this._highlightElements(elements);
                            return [2 /*return*/];
                    }
    ...
    var CopyButton = /** @class */ (function () {
        ...
        CopyButton.prototype._animate = function () {
            ...
            nativeMethods$c.setTimeout.call(window, function () { return _this._resetAppearance(); }, ANIMATION_TIMEOUT);
        };
        ...
        CopyButton.prototype._changeAppearance = function (value, fontWeight) {
            nativeMethods$c.inputValueSetter.call(this.element, value);
    ...
    var HideButton = /** @class */ (function () {
        ...
        HideButton.prototype._showAndHide = function (selectorInspectorPanel) {
            nativeMethods$d.elementClassListGetter.call(selectorInspectorPanel).toggle(SELECTOR_INSPECTOR_PANEL_HIDDEN_CLASSNAME);
        };
        return HideButton;
    }());
    ...
    var SelectorInspectorPanel = /** @class */ (function () {
        function SelectorInspectorPanel() {
            ...
            var copyButton = new CopyButton(this.selectorInputContainer);
            var container = new MainContainer(pickButton.element, this.selectorInputContainer.element, copyButton.element);
        ...
        SelectorInspectorPanel.prototype.show = function (selector) {
    ...
    var nativeMethods$e = hammerhead$1__default.nativeMethods;
    var evalIframeScript = hammerhead$1__default.EVENTS.evalIframeScript;
    nativeMethods$e.objectDefineProperty(window, '%testCafeUI%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead$1__default.on(evalIframeScript, function (e) { return initTestCafeUI(nativeMethods$e.contentWindowGetter.call(e.iframe), true); });
